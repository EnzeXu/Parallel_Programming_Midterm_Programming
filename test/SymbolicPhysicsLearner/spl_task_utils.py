...
rule_map = {
    ...
    'Nguyen-11': ['A->x0', 'A->x1', 'A->A+A', 'A->A-A', 'A->A*A', 'A->A/A',
                  'A->exp(A)', 'A->log(B)', 'A->sqrt(B)', 'A->cos(B)', 'A->sin(B)', 
                  'B->B+B', 'B->B-B', 'B->1', 'B->x0', 'B->x1', 'B->x0**2', 'B->x1**2', 'B->x0*x1', 
                  'B->x0**2*x1', 'B->x0*x1**2', 'B->x0**3', 'B->x1**3'],

    'Nguyen-12': ['A->(A+A)', 'A->(A-A)', 'A->A*A', 'A->A/A',
                  'A->x0', 'A->x0**2', 'A->x0**4', 'A->x1', 'A->x1**2', 'A->x1**4', 
                  'A->1', 'A->2', 'A->exp(A)', 
                  'A->cos(x0)', 'A->sin(x0)', 'A->cos(x1)', 'A->sin(x1)'], 
